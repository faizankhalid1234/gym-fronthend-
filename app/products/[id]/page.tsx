  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-50 to-white py-8 px-4">
      <div className="max-w-7xl mx-auto">
        <Link
          href="/products"
          className="text-primary-600 hover:text-primary-700 mb-6 inline-flex items-center gap-2 font-semibold"
        >
          ← Back to Products
        </Link>
          ...
          <div className="md:flex">
            ...
            <div className="md:w-1/2 p-8 sm:p-10">
              ...
              <button
                ...
                className={`w-full py-3.5 rounded-xl font-semibold text-white transition duration-300 shadow-lg ${
                  product.stock > 0
                    ? added
                      ? 'bg-green-600'
