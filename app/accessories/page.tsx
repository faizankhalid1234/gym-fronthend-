    ...
    <div className="min-h-screen bg-gradient-to-b from-slate-50 via-white to-primary-50/40 py-6 sm:py-8 md:py-10 px-4 sm:px-6">
      <div className="max-w-7xl mx-auto">
        <div className="rounded-3xl bg-gradient-to-r from-primary-900 via-primary-800 to-primary-700 text-white p-6 sm:p-8 mb-8 shadow-xl">
          <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold">Gym Accessories</h1>
          <p className="mt-2 text-primary-100 max-w-2xl">Discover gloves, wraps, straps and support gear for safe workouts.</p>
        </div>
              ...
              >
                ...
                <div className="p-4 sm:p-5">
                  ...
                  <div className="flex justify-between items-center mb-2">
                    ...
                    <span className="text-xs sm:text-sm text-primary-700 capitalize bg-primary-50 px-2 py-1 rounded-full">
