  ...
  if (orderPlaced) {
    return (
      <div className="min-h-screen bg-gradient-to-b from-slate-50 to-white flex items-center justify-center px-4">
        <div className="bg-white rounded-2xl shadow-xl border border-slate-100 p-8 text-center max-w-md">
    ...
    <div className="min-h-screen bg-gradient-to-b from-slate-50 to-white py-8 px-4 sm:px-6">
      <div className="max-w-7xl mx-auto">
        <div className="rounded-3xl bg-gradient-to-r from-primary-900 via-primary-800 to-primary-700 text-white p-6 sm:p-8 mb-8 shadow-xl">
          ...
          <p className="mt-2 text-primary-100">Review your order and complete checkout quickly.</p>
        </div>
        ...
        {cartItems.length === 0 ? (
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-2 space-y-4">
              {cartItems.map((item) => (
                <div key={`${item.id}-${item.type}`} className="bg-white rounded-2xl shadow-md border border-slate-100 p-4 sm:p-6 flex flex-col sm:flex-row gap-4">
            ...
            <div className="lg:col-span-1">
              <div className="bg-white rounded-2xl shadow-lg border border-slate-100 p-6 sticky top-4">
