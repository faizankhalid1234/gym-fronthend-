                ...
                >
                  ...
                  <div className="p-4 sm:p-5">
                    ...
                    <div className="flex justify-between items-center">
                      <span className="text-xl sm:text-2xl font-bold text-primary-600">${product.price.toFixed(2)}</span>
              ...
              {featuredAccessories.map((accessory) => (
                ...
                >
                  ...
                  <div className="p-4 sm:p-5">
                    ...
                    <div className="flex justify-between items-center">
                      <span className="text-xl sm:text-2xl font-bold text-primary-600">${accessory.price.toFixed(2)}</span>
                      <span className="text-xs sm:text-sm text-gray-500 capitalize bg-gray-100 px-2 py-1 rounded-full">
